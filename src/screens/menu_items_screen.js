...
class MenuItemsScreen extends GWE.Screen {
  ...
  onEnter() {
    ...
    this.uiTopMenu.addWidget(new GWE.UIMenuText({ text: 'Utiliser' }));
    ...
    this.uiFilterMenu.addWidget(new GWE.UIMenuText({ text: 'Potion' }));
    this.uiFilterMenu.addWidget(new GWE.UIMenuText({ text: 'Nourriture' }));
    this.uiFilterMenu.addWidget(new GWE.UIMenuText({ text: 'Autre' }));
