...
class MenuScreen extends GWE.Screen {
  ...
  onEnter() {
    ...
    this.uiMainMenu.addWidget(new GWE.UIMenuText({ text: 'Objets' }));
    this.uiMainMenu.addWidget(new GWE.UIMenuText({ text: 'Equipements' }));
    this.uiMainMenu.addWidget(new GWE.UIMenuText({ text: 'Status' }));
  ...
  handleHeroesItemSelected(data) {
    ...
    GWE.screenManager.requestPushScreen(new MenuStatusScreen(this.app), { hero : hero });
  }
}
